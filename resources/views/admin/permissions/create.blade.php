        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="card shrink-0 w-full max-w-sm shadow-2x">
                    <form class="card-body" method="post" action="{{ route('admin.permissions.store') }}">
                        @csrf
                        <div class="form-control">
                            <label class="label">
                                <span class="label-text text-black">Permission Name</span>
                            </label>
                            <input type="text" placeholder="Permission Name" name="name" class="input input-bordered bg-slate-100 border-blue-500 text-black" required />
                        </div>
